...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    left_to_right = ldbws.service.GetArrivalBoard(crs=right_crs, filterType="from", filterCrs=left_crs, numRows=2)
    
    lr_train_details = [ldbws.service.GetServiceDetails(serviceID=service.serviceID)
                        for service in left_to_right.trainServices.service]
    print(lr_train_details)
